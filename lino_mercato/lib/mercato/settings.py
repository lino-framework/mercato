...
class Site(Site):
    ...
    obj2text_template = "**{0}**"
    project_model = 'mercato.Client'
    workflows_module = 'lino_mercato.lib.mercato.workflows'
    custom_layouts_module = 'lino_mercato.lib.mercato.layouts'
    user_types_module = 'lino_mercato.lib.mercato.user_types'
    auto_configure_logger_names = "atelier django lino lino_xl lino_mercato"
